# AGENTS.md — Atlas TA · Contexto de desarrollo activo

> Documento de contexto para sesiones de desarrollo con Codex (Cowork).
...
Atlas_TA/
├── agente/
│   ├── atlas_agent.py          # Agente conversacional principal (Codex API)
│   └── vanna_sql/
│       ├── __init__.py
...
Usuario (lenguaje natural)
        │
        ▼
  Atlas Agent (atlas_agent.py · Codex API)
        │
